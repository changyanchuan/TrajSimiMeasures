...
def clean_and_output_data():
    ...
    # input_file = os.path.join(Config.data_dir, 'geolife_all_20inf_rawtext')
    input_file = os.path.join(Config.data_dir, 'geolife_6ring_20inf_rawtext')
...
# cd utils
# nohup python geolife.py &> ../result &
