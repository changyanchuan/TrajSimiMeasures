...
def clean_and_output_data():
    ...
    input_file = os.path.join(Config.data_dir, 'germany_len20200_raw')
...
# cd utils
# nohup python germany.py &> ../result &
